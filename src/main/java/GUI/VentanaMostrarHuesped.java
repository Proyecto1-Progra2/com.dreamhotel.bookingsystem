...
public class VentanaMostrarHuesped extends BorderPane implements Runnable {
    ...
    public VentanaMostrarHuesped(Client client, Pane contentPane) {
    ...
    private void initComponents() {
        ...
        Label title = new Label("Mostrar Huéspedes");
        ...
        btnMostrar.setOnAction(e -> this.mostrarHuesped("mostrar"));
    ...
    public void run() {
        while (true) {
            try {
                if (this.client.isMostrado()) {
                    this.taMostar.setText(this.client.getInfoMostrar());
                    this.client.setInfoMostrar("");
                    this.client.setMostrado(false);
                }
                Thread.sleep(100);
