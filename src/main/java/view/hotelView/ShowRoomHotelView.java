...
public class ShowRoomHotelView extends BorderPane implements Runnable {
    ...
    public ShowRoomHotelView(Client client, Pane contentPane) {
    ...
    private void initComponents() {
        ...
        bSearch.setOnAction(e -> {
            this.RoomList(Action.HOTEL_ROOMS, tNumber.getText());
        });
